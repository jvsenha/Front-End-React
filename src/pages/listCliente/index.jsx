...
const ListClienteEmp = () => {
    ...
    useEffect(() => {
        ...
        fetch("http://localhost:8080/cliente/listar", {
            ...
            .then(retorno_convert => {
                const clientes = retorno_convert.map((cliente) => {
                    // Mapeie os campos da API para o objeto cliente
                    return {
    ...
    const clientesFiltrados = useMemo(() => {
        ...
        return clientes
            .filter((cliente) => cliente.nomeUser.toLowerCase().trim().includes(lowerBusca) || cliente.login.toLowerCase().trim().includes(lowerBusca) || cliente.emailCliente.toLowerCase().trim().includes(lowerBusca));
    }, [busca, clientes]);
        ...
        <>
            ...
            < section className="Main">
                ...
                <section className="table">
                    <Table vetor={clientesFiltrados} onRemover={remover} />
